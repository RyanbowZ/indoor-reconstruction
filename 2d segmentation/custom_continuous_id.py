...
video_dir = "notebooks/videos/716/render_new/renders/converted_images"
# 'output_dir' is the directory to save the annotated frames
output_dir = "./outputs/rendered_716_new"
# 'output_video_path' is the path to save the final video
output_video_path = "./outputs/rendered_716_new/output.mp4"
